              ...
              <div>
                <div className="flex flex-col md:flex-row justify-between items-end mb-8 gap-6">
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">During my internship at Keystone Group, I worked on DAGDIG, an AI-powered command-line penetration testing framework designed for web applications and websites. I contributed to the development of an intelligent security testing workflow by integrating multimodal LLMs, Bash scripting, and LLM frameworks to assist with reconnaissance, vulnerability discovery, and penetration testing tasks. The project allowed me to explore the integration of AI into cybersecurity and strengthen my skills in security automation, web application testing, and AI-driven security solutions.</p>
                  </div>
                </div>
